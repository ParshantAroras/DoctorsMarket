...
export const HEADER_BACKBUTTON_COLOR = '#2cf6d0';
...
export const APPBAR_HEIGHT = Platform.OS === 'ios' ? 56 : 45;
export const STATUSBAR_HEIGHT = getStatusBarHeight();
export const DRAWER_WIDTH = WINDOW_WIDTH - (Platform.OS === 'android' ? 56 : 64);
